...
-   Technical Demo built using [Quarto](https://quarto.org/)

-   All data used in this report is synthetic, and is only used demonstratively for future prototypes using live data

-   Everything in the [Automated Outputs](#automation_output) section is built using templates, and so is automatically generated, meaning some elements need to be tweaked.
